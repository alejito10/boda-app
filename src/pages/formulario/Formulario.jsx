...
export function Formulario() {
	...
	return (
		<main>
			<Helmet>
				<title>Formulario || Alex y Natalia</title>
				<meta
					name="description"
					content="Formulario de alergias, intolerancias y personas que van a usar el autobus"
				/>
			</Helmet>
			<h2 className="subtitulo">¿Alergias o intolerancias?</h2>
			<p className="texto-alergias">
				Queremos que disfrutéis de nuestro día al máximo y cómo os merecéis, así
				que si tenéis alguna alergia o intolerancia,
				<br />
				tendremos todo preparado para que no os tengáis que preocupar de nada.
				<br /> Sólo tenéis que rellenar el formulario a continuación y el staff
				de Valquijancho se encargará de todo.
			</p>
